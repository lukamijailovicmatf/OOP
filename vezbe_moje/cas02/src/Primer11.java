...
public class Primer11 {
    ...
    public static void main(String[] args) {
        ...
        String t = sc.nextLine(); // unosim jednu liniju do novog reda

        String ms = uMalaSlova(t);
        // U klasi String postoji metod toLowerCase() koji za dati string vraca novi u kome su velika
        // slova prevedena u mala, a ostali karakteri su nepromenjeni.
    ...
    static String uMalaSlova(String t){
        ...
        // Stringovi su imutabilni (nepromenljivi) tako da cemo transformaciju izvrsiti nad nizom karaktera
        // koji cemo posle vratiti kao String
        ...
        // Prvi nacin
        // Metod valueOf() od promenljive koju prima kao argument vraca njenu stringovanu reprezentaciju
