...
public class FormatiranoCitanje {
    public static void main(String[] args) {
        ...
        // npr. ako je relativna putanja: DirProjekta/src/cas08/1.txt
        // onda: Path putanja = Paths.get("src", "cas08", "1.txt");
        Path putanja = Paths.get("Datoteke/1.txt");
        ...
        try (Scanner ulaz = new Scanner(putanja.toFile())) {
            // ako je sadrzaj datoteke: Marko Markovic 20 9.5
