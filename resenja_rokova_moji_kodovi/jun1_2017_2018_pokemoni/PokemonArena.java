...
public class PokemonArena extends Application {
    ...
    public static void ucitaj() {
        try {
            ...
            // prolazimo kroz kolekciju i uzimamo liniju po liniju odatle
    ...
    public void start(Stage stage) throws Exception {
        ...
        // ToggleGroup radimo da najvise jedno radio dugme bude selektovano
        ...
        koren.getChildren().addAll(btUcitaj, taPokemoni, taBorba, rbMagija1, rbMagija2, hBox);

        // akcije za ucitavanje
        btUcitaj.setOnAction(e -> {
            ...
            // Trazimo prvog koji je CpuPokemon
            for (Pokemon p: pokemoni) {
            ...
            taPokemoni.appendText("Izabrani pokemoni:\n" + pokemon1 + "\n");
            taPokemoni.appendText(pokemon2 + "\n");
            taPokemoni.appendText("\n");
        });

        // akcije za izbor magije
        ...
        // kada pravimo scenu prosledjujemo koren i dimenzije prozora
        Scene scena = new Scene(koren,600,600);
        stage.setScene(scena);
        stage.setTitle("Pokemon Arena");
        stage.show();
    }
}
